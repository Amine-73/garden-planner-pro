...
import { Box, Typography, Paper, Button,TableCell } from '@mui/material';
...
const GardenHistory = ({ savedGardens, deleteGarden, handleLoadGarden }) => {
  ...
  <table style={{ width: '100%', borderCollapse: 'collapse' }}>
    <thead style={{ backgroundColor: '#f1f8e9' }}>
      <tr>
        <th style={{ padding: '16px', textAlign: 'left' }}>Garden Name</th> {/* Updated Header */}
    ...
    <tbody>
      {savedGardens.map((garden) => {
        ...
        return (
          ...
          >
            {/* 1. GARDEN NAME COLUMN (New!) */}
            <td style={{ padding: '16px', fontWeight: 700, color: '#1b5e20' }}>
