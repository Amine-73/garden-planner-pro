...
const topPerformingPlants = useMemo(() => {
  ...
  return (
    <Box id="garden-report"  sx={{ width: '100vw', minHeight: '100vh', bgcolor: '#f8faf8', m: 0, p: 0 ,display: 'flex', 
      flexDirection: 'column',
      // Add padding equal to the height of your floating bar + some extra
      pb: { xs: '120px', md: '100px' }}}>
...
export default MainGardenPlanner;